...
const styles = StyleSheet.create({
  ...
  hero: {
    margin: 12, marginBottom: 6, borderRadius: 18,
    backgroundColor: COLORS.header, padding: 16,
    overflow: 'hidden',
  },
  heroTop: { flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 10 },
  heroIconCircle: { width: 42, height: 42, borderRadius: 21, backgroundColor: 'rgba(255,255,255,0.18)', alignItems: 'center', justifyContent: 'center' },
  heroTitle: {},
  heroHospital: { fontSize: 18, fontWeight: '800', color: '#fff' },
  heroSubtitle: { fontSize: 12, color: 'rgba(255,255,255,0.8)' },
  heroDate: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: 'rgba(255,255,255,0.15)', borderRadius: 12, padding: 10 },
  heroDay: { fontSize: 14, color: '#fff', fontWeight: '600', textTransform: 'capitalize' },
  heroStatsRow: { flexDirection: 'row', alignItems: 'center', marginTop: 10 },
  heroStat: { flex: 1, alignItems: 'center' },
  heroStatValue: { fontSize: 21, fontWeight: '800', color: '#fff' },
  heroStatLabel: { fontSize: 10, color: 'rgba(255,255,255,0.7)', marginTop: 2, textTransform: 'uppercase', letterSpacing: 0.5 },
  heroDivider: { width: 1, height: 28, backgroundColor: 'rgba(255,255,255,0.2)' },

  sectionTitle: { fontSize: 16, fontWeight: '700', color: COLORS.text, marginHorizontal: 12, marginTop: 10, marginBottom: 8 },

  areaGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, paddingHorizontal: 12 },
  areaCardWrap: { width: 200, flexGrow: 1, maxWidth: 380 },
  areaCard: { flex: 1, minHeight: 140, borderRadius: 16, padding: 14, backgroundColor: COLORS.surface, justifyContent: 'space-between' },
  areaTopRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  areaIcon: { width: 44, height: 44, borderRadius: 14, alignItems: 'center', justifyContent: 'center' },
  areaBadge: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 9, paddingVertical: 4, borderRadius: 12 },
  areaBadgeText: { fontSize: 13, fontWeight: '800' },
  areaMid: { marginTop: 10 },
  areaName: { fontSize: 15, fontWeight: '800', color: COLORS.text, lineHeight: 19 },
  areaSup: { fontSize: 12, color: COLORS.textLight, marginTop: 2 },
  areaFooter: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 10, borderTopWidth: 1, borderTopColor: COLORS.border, paddingTop: 8 },
  ...
  legend: { margin: 12, borderRadius: 14, padding: 14, backgroundColor: COLORS.surface },
  legendTitle: { fontSize: 15, fontWeight: '700', color: COLORS.text, marginBottom: 10 },
  ...
  legendDot: { width: 34, height: 26, borderRadius: 6, alignItems: 'center', justifyContent: 'center' },
